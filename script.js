...
submitbtn.addEventListener("click",function(event){
    ...
    var total=Tamil+English+Maths+Sceince+Social       //Total Calculation
    var average=total/5           // Average Calculation
    ...
    tAverage.innerHTML="Average : " + average +"%"      //Average Output
    tTotalmark.innerHTML="Total Mark : " + total        // Total Ouput
